...
LETTERA 'X': NAVE COLPITA (ROSSO)
LETTERA 'O': BERSAGLIO MANCATO (AZZURRO)
LETTERA 'c': SIMBOLO DELLA NAVE CORAZZATA (INDICATA IN GIALLO E VISIBILE DOPO L'AFFONDAMENTO)
LETTERA 'i': SIMBOLO DELLA NAVE INCROCIATORE (INDICATA IN GIALLO E VISIBILE DOPO L'AFFONDAMENTO)
LETTERA 's': SIMBOLO DELLA NAVE SOTTOMARINO (INDICATA IN GIALLO E VISIBILE DOPO L'AFFONDAMENTO)
NUMERI DA 0 A 6: IDENTIFICANO LE NAVI SULLA GRIGLIA DI GIOCO (IN VERDE, 0 E 1 PER LE CORAZZATE, 2 E 3 PER GLI INCROCIATORI, DA 4 A 6 PER I SOTTOMARINI)
